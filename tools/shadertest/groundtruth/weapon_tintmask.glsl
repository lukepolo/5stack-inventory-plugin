...
// cbuffer ID 5618 (name: _Globals_), member index 38 (name: g_cInvulnerabilityColor) cannot be expressed with either HLSL packing layout or packoffset.
//
// Re-attempting reflection with the GLSL backend.

// Source 2 Viewer 19.2.0.0 - https://valveresourceformat.github.io
// SPIR-V source (68336 bytes), GLSL reflection with SPIRV-Cross by KhronosGroup
// Static combos: S_ENABLE_ADJUSTMENTS, S_TINT_MASK
...
struct _174
{
    ...
    int g_bMaskRoughnessAdjustmentsByTintMask;
    float g_fHueShift;
    float g_fSaturation;
    float g_fContrast;
    float g_fBrightness;
    ...
    int g_bMaskDetailTextureByTintMask;
    int bIridescence;
...
layout(set = 1) uniform _174 _Globals_;
...
layout(set = 3) uniform _2240 PerViewLightingConstantBufferGpu_t;
...
void main()
{
    ...
    vec4 _21760 = texture(sampler2D(g_bindless_Texture2D_float4[_Globals_.g_tColor], g_bindless_Sampler[_Globals_.g_sUserConfigAllowGlobalMipBias]), _23261.xy);
    vec4 _19334 = texture(sampler2D(g_bindless_Texture2D_float4[_Globals_.g_tTintMask], g_bindless_Sampler[_Globals_.g_sUserConfig]), _23261.xy);
    vec3 _6652 = _21760.xyz;
    vec3 _10910 = mix(_6652, _6652 * input_5.xyz, vec3(_19334.x));
    ...
    vec4 _21761 = texture(sampler2D(g_bindless_Texture2D_float4[_Globals_.g_tMetalness], g_bindless_Sampler[_Globals_.g_sUserConfig]), _23261.xy);
    float _20079 = mix(_Globals_.g_vMetalnessRemapRange.x, _Globals_.g_vMetalnessRemapRange.y, _21761.y);
    float _24590 = _21761.z;
    float _6815 = _21761.x;
    vec2 _13746 = vec2(_6815);
    ...
    if (_15436)
    {
        float _21270 = saturate((_6815 - 0.75) * 4.0);
        ...
        _13137 = mix(_10910, pow(_10910, vec3(1.60000002384185791015625)) * 0.60000002384185791015625, vec3(_23650));
        ...
        _13618 = saturate(_22907 * 2.0);
        _7308 = mix(_20480, vec3(_13998.xy, _8927) * vec3(-1.0, -1.0, 1.0), vec3(_18483 * 0.25));
    }
    else
    {
        _13137 = _10910;
    ...
    vec4 _19069 = texture(sampler2D(g_bindless_Texture2D_float4[_Globals_.g_tTintMask], g_bindless_Sampler[_Globals_.g_sUserConfig]), _23261.xy);
    float _17477 = _19069.x;
    vec4 _21763 = texture(sampler2D(g_bindless_Texture2D_float4[_Globals_.g_tDetail], g_bindless_Sampler[_Globals_.g_sUserConfig]), input_1.xy);
    float _21710;
    SPIRV_CROSS_BRANCH
    if (_Globals_.g_bMaskDetailTextureByTintMask != 0)
    {
        _21710 = _Globals_.g_fDetailBlendFactor * _17477;
    }
    else
    {
        _21710 = _Globals_.g_fDetailBlendFactor;
    }
    vec3 _21711;
    SPIRV_CROSS_BRANCH
    if (_Globals_.g_nDetailBlendMode == 1)
    {
        _21711 = mix(_13137.xyz, _21763.xyz, vec3(_21710));
    }
    else
    {
        _21711 = mix(_13137.xyz, _13137.xyz * _21763.xyz, vec3(_21710));
    }
    bool _14876 = _Globals_.g_bMaskRoughnessAdjustmentsByTintMask != 0;
    float _12887;
    if (_14876)
    {
        _12887 = mix(1.0, _Globals_.g_fTextureRoughnessContrast, _17477);
    }
    else
    {
        _12887 = _Globals_.g_fTextureRoughnessContrast;
    }
    float _20617;
    if (_14876)
    {
        _20617 = mix(1.0, _Globals_.g_fTextureRoughnessBrightness, _17477);
    }
    else
    {
        _20617 = _Globals_.g_fTextureRoughnessBrightness;
    }
    vec3 _18810 = saturate(mix(vec3(0.5), _21711.xyz, vec3(_Globals_.g_fContrast)) * _Globals_.g_fBrightness);
    ...
    vec3 _25172 = mix(_21711.xyz, saturate(mix(vec3(dot(_24555.xyz, vec3(0.2125000059604644775390625, 0.7153999805450439453125, 0.07209999859333038330078125))), _24555.xyz, vec3(_Globals_.g_fSaturation))).xyz, vec3(_17477));
    float _20574 = _25172.x;
    float _6641 = _25172.y;
    float _24623 = _25172.z;
    vec3 _20195;
    SPIRV_CROSS_BRANCH
    if (_Globals_.g_flPearlescentScale != 0.0)
    {
        vec3 _16414 = _25172.xyz;
        ...
        do
        {
            float _18474 = max(_20574, max(_6641, _24623));
            if (_18474 == 0.0)
            {
                _12936 = 0.0;
                break;
            }
            _12936 = (_18474 - min(_20574, min(_6641, _24623))) / _18474;
            break;
        } while(false);
        _20195 = mix(vec3(dot(_25172.xyz, vec3(0.2125000059604644775390625, 0.7153999805450439453125, 0.07209999859333038330078125))), ((_16414 * _15271) + (cross(vec3(0.57735002040863037109375), _16414) * sin(_21433))) + ((vec3(0.57735002040863037109375) * dot(vec3(0.57735002040863037109375), _16414)) * (1.0 - _15271)), vec3(pow(_12936, 0.125)));
    }
    else
    {
        _20195 = _25172;
    ...
    if (_14874)
    {
        _12888 = _Globals_.g_bDontFlipBackfaceNormals == 0;
    }
    else
    {
        _12888 = false;
    ...
    vec2 _11004 = max(saturate((((_16306.xy - vec2(0.5)) * _12887) + vec2(0.5)).xy * _20617).xy, vec2(pow(saturate(max(dot(_10347, _10347), dot(_12420, _12420))), 0.333000004291534423828125)));
    vec3 _10171 = -_24347;
    ...
    {
        _21713 = _21712 * textureLod(sampler2D(g_bindless_Texture2D_float4[PerViewConstantBufferCsgo_t._m9], g_bindless_Sampler[_Globals_.g_sUserConfig]), (_11408.xy * PerViewConstantBuffer_t._m3.xy).xy, 0.0).x;
    }
    else
    {
        _21713 = _21712;
    ...
    vec3 _24878;
    SPIRV_CROSS_BRANCH
    if ((dot(PerViewLightingConstantBufferGpu_t._m16.xyz, _24735) * _21714) > 0.0)
    {
        ...
        vec3 _16808 = (PerViewLightingConstantBufferGpu_t._m17.xyz * _21714).xyz;
    ...
    for (;;)
    {
        ...
        for (;;)
        {
            ...
            do
            {
                ...
                {
                    _12891 = !all(lessThanEqual(abs((g_BarnLights_1._m0[_12608]._m15 * vec4(input_2.xyz, 1.0)).xyz), vec3(1.0)));
                }
                if (_12891)
                {
                    _13212 = _13140;
    ...
    if (PerViewConstantBufferCsgo_t._m29 != 0.0)
    {
        ...
        {
            _21715 = _11901 + ((-PerViewConstantBuffer_t._m7.xyz) * _9642);
        }
        vec4 _19975 = vec4(_21715.xyz, 1.0) * PerViewConstantBufferCsgo_t._m15;
        float _20177 = _19975.w;
        vec2 _11415 = _19975.xy / vec2(_20177);
        vec4 _6653;
        _6653.x = clamp(((_11415.x + 1.0) * PerViewConstantBuffer_t._m2.x) * 0.5, 0.0, PerViewConstantBuffer_t._m2.x - 1.0);
        _6653.y = clamp(((1.0 - _11415.y) * PerViewConstantBuffer_t._m2.y) * 0.5, 0.0, PerViewConstantBuffer_t._m2.y - 1.0);
        _6653.w = _20177;
        _11008 = _21715;
        _14444 = _6653;
    }
    ...
    uvec2 _6816 = uvec2(_14444.xy - PerViewConstantBuffer_t._m1.xy) >> _7663;
    uint _12130 = PerViewLightingConstantBufferGpu_t._m11.y + (((_6816.y * PerViewLightingConstantBufferGpu_t._m12.y) + _6816.x) * PerViewLightingConstantBufferGpu_t._m11.z);
    ...
    vec3 _13436 = vec3(_21713 * _17476).xyz;
    ...
    if (_Globals_.g_bFogEnabled != 0)
    {
        ...
        do
        {
            ...
            {
                _12894 = (_10061.z * PerViewConstantBufferCsgo_t._m21.z) < PerViewConstantBufferCsgo_t._m21.y;
            }
            else
            {
                _12894 = false;
        ...
        do
        {
            ...
            {
                _12895 = (PerViewConstantBufferCsgo_t._m25.z * _10061.z) < PerViewConstantBufferCsgo_t._m25.y;
            }
            else
            {
                _12895 = false;
